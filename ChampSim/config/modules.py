...
def get_pref_lines(pref_data):
    ...
    pref_nonbranch_variant_data = [
        ...
        ('prefetcher_cache_operate', (('uint64_t', 'addr'), ('uint64_t', 'ip'), ('uint8_t', 'cache_hit'), ('uint8_t', 'type'), ('uint64_t', 'metadata_in')), 'uint64_t', 'std::bit_xor'),
        ('prefetcher_cache_fill', (('uint64_t', 'addr'), ('uint32_t', 'set'), ('uint32_t', 'way'), ('uint8_t', 'prefetch'), ('uint64_t', 'evicted_addr'), ('uint64_t', 'metadata_in')), 'uint64_t', 'std::bit_xor'),
